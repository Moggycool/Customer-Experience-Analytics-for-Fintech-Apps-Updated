...
**Dataset size:** 1,786 reviews (from PostgreSQL).


**Cross-bank snapshot:** Highest negative share: **BOA** (56.3%). Highest average rating: **DASHEN** (4.05).
...
- `figures/negative_trend_monthly.png` — Monthly negative sentiment trend
- `figures/top_negative_keywords_overall.png` — Top complaint keywords (negative reviews)
